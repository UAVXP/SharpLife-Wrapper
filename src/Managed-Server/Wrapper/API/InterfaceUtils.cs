...
namespace Server.Wrapper.API
{
    internal static class InterfaceUtils
    {
        ...
        internal static void InitializeField(string prefix, object ifaceInstance, Type impl, object implInstance, FieldInfo field)
        {
        ...
        /// <param name="impl">Implementation type</param>
        /// <param name="implInstance">Instance of the implementation. null if the interface uses static methods</param>
        internal static void InitializeFields(string prefix, object ifaceInstance, Type impl, object implInstance = null)
        {
            var iface = ifaceInstance.GetType();
        ...
        /// </summary>
        internal enum UnmanagedStringResult
        {
            Success = 0,
            Truncated
        }
        ...
        internal static unsafe UnmanagedStringResult CopyStringToUnmanagedBuffer(string str, byte* buffer, int bufferSizeInBytes)
        {
            if (str == null)
            {
        ...
        internal static IntPtr AllocateUnmanagedString(string str)
        {
            if (str == null)
            {
                throw new ArgumentNullException(nameof(str));
        ...
        internal static bool SetupInterface<TIFace, TImpl>(out TIFace pFunctionTable, TImpl implementation)
            ...
            where TImpl : class
        {
            ...
            try
            {
                InitializeFields(ManagedAPI.DelegateInstanceNamePrefix, pFunctionTable, typeof(TImpl), implementation);
            }
            catch (Exception e)
            {
