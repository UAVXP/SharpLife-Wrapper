...
namespace Server.Wrapper.API
{
    internal static class Program
    {
        ...
        {
            InterfaceUtils.DebugLoggingEnabled = false;
        ...
        internal static bool GetEntityAPI(out DLLFunctions pFunctionTable)
        {
            ...
            if (InterfaceUtils.SetupInterface(out pFunctionTable, Wrapper.DLLFunctions))
            {
        ...
        internal static bool GetNewDLLFunctions(out NewDLLFunctions pFunctionTable)
        {
            ...
            if (InterfaceUtils.SetupInterface(out pFunctionTable, Wrapper.NewDLLFunctions))
            {
        ...
        internal static bool GetEngineOverrides(out EngineOverrides pFunctionTable)
        {
            ...
            if (InterfaceUtils.SetupInterface(out pFunctionTable, Wrapper.EngineOverrides))
            {
